...
IMGUI_DIR = imgui
SOURCES = main.cpp OpenGLHelper.cpp MosaicMesh.cpp MemoryManager.cpp SDHRNetworking.cpp AppletiniUartTerminal.cpp SDHRManager.cpp SDHRWindow.cpp TimedTextManager.cpp LogTextManager.cpp
