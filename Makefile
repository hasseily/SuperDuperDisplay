...
IMGUI_DIR = imgui
SOURCES = main.cpp OpenGLHelper.cpp MosaicMesh.cpp SDHRNetworking.cpp SDHRManager.cpp SDHRWindow.cpp A2VideoManager.cpp A2WindowBeam.cpp shader.cpp PostProcessor.cpp CycleCounter.cpp EventRecorder.cpp
