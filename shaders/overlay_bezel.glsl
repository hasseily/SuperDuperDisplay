...
The main problem is that to avoid another render pass, we need to simulate the postprocessing
of the texture being reflected as much as possible. The most important thing being the final
position and size of the reflected quad.
*/
