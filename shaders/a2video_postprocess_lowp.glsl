...
#ifdef GL_ES
#define COMPAT_PRECISION_L lowp
#define COMPAT_PRECISION_M mediump
precision mediump float;
#else
#define COMPAT_PRECISION_L
#define COMPAT_PRECISION_M
#endif
...
uniform COMPAT_PRECISION_M int FrameCount;
uniform COMPAT_PRECISION_M vec2 OutputSize;
uniform COMPAT_PRECISION_M vec2 TextureSize;
uniform COMPAT_PRECISION_M vec2 InputSize;
...
uniform COMPAT_PRECISION_M vec2 TextureSize;
uniform COMPAT_PRECISION_M vec2 InputSize;
uniform COMPAT_PRECISION_M vec2 ViewportSize;
uniform COMPAT_PRECISION_M vec4 VideoRect;
...
uniform COMPAT_PRECISION_M int POSTPROCESSING_LEVEL;
...
uniform COMPAT_PRECISION_M float BARRELDISTORTION;
uniform COMPAT_PRECISION_M float BGR;
uniform COMPAT_PRECISION_L float BLACK;
uniform COMPAT_PRECISION_M float BR_DEP;
uniform COMPAT_PRECISION_M float BRIGHTNESs;
uniform COMPAT_PRECISION_L float C_STR;
uniform COMPAT_PRECISION_M float CENTERX;
uniform COMPAT_PRECISION_M float CENTERY;
uniform COMPAT_PRECISION_M float CONV_B;
uniform COMPAT_PRECISION_M float CONV_G;
uniform COMPAT_PRECISION_M float CONV_R;
uniform COMPAT_PRECISION_M float CORNER;
uniform COMPAT_PRECISION_L float GB;
uniform COMPAT_PRECISION_L float MASKH;
uniform COMPAT_PRECISION_L float MASKL;
uniform COMPAT_PRECISION_M float MSIZE;
uniform COMPAT_PRECISION_M float P_GLOW;
uniform COMPAT_PRECISION_L float RB;
uniform COMPAT_PRECISION_L float RG;
uniform COMPAT_PRECISION_M float SATURATION;
uniform COMPAT_PRECISION_L float SCANLINE_WEIGHT;
uniform COMPAT_PRECISION_M float SLOTW;
uniform COMPAT_PRECISION_M float WARPX;
uniform COMPAT_PRECISION_M float WARPY;
uniform COMPAT_PRECISION_M float ZOOMX;
uniform COMPAT_PRECISION_M float ZOOMY;
uniform COMPAT_PRECISION_L int iCOLOR_SPACE;
uniform COMPAT_PRECISION_L int iM_TYPE;
uniform COMPAT_PRECISION_L int iSCANLINE_TYPE;
